...
import InfrastructurePlanning from './InfrastructurePlanning'
import './App.css'
import { translations, stateTranslations, dataTranslations } from './translations'

const App = () => {
    const [viewMode, setViewMode] = React.useState('insights') // 'insights' or 'infra'
    ...
    return (
        <div className={`dashboard-container lang-${language}`}>
            ...
            <div className="view-toggle-row">
                <div className="view-toggle-bar glass">
                    <button
                        className={`view-toggle-btn ${viewMode === 'insights' ? 'active' : ''}`}
                    ...
                    <button
                        className={`view-toggle-btn ${viewMode === 'infra' ? 'active' : ''}`}
